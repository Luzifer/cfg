...
alias share='vault2env --key=secret/minio/knut-cc -- share --bucket=knut-cc --file-template="file/{{ printf \"%.8s\" .Hash}}/{{ .SafeFileName }}" --base-url="https://knut.cc/#" --progress'
alias shareperm='vault2env --key=secret/minio/knut-cc -- share --bucket=knut-cc --file-template="permanent/{{ printf \"%.8s\" .Hash}}/{{ .SafeFileName }}" --base-url="https://knut.cc/#" --progress'
