...
alias shareperm='AWS_REGION=us-east-1 vault2env --key=secret/aws/private -- share --bucket=share-luzifer-io-s3bucket-164ztrtyq1f35 --base-path="permanent/{{ printf \"%.8s\" .Hash}}" --base-url="https://knut.cc/#" --progress'
